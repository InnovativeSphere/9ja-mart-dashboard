  ...
  return (
    <div className="analytics-wrapper">
      <div className="px-2 sm:px-4 py-6 space-y-8 animate-fadeIn">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm opacity-60 mt-1">Platform performance at a glance.</p>
          </div>
            ...
            {["yearly", "monthly"].map((p) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  period === p ? "bg-white/20" : "bg-white/5 opacity-60 hover:bg-white/10"
                }`}
              >
      ...
      <style jsx>{`
        ...
        .analytics-wrapper .glass-card {
          background: rgba(255, 255, 255, 0.04) !important;
          backdrop-filter: blur(20px);
          -webkit-backdrop-filter: blur(20px);
        }
        .analytics-wrapper .animate-fadeIn {
