...
import { X, User, Mail, ShoppingBag, DollarSign, MapPin, Calendar } from "lucide-react";
...
export default function BuyerViewModal({ buyer, onClose }: Props) {
  useEffect(() => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-grid">
          ...
          <Detail icon={ShoppingBag} label="Orders" value={`${buyer.orders}`} />
          <Detail icon={DollarSign} label="Total Spent" value={buyer.spent} />
          <Detail icon={MapPin} label="Location" value={buyer.location} />
          <Detail icon={Calendar} label="Last Order" value={buyer.lastOrder} />
        </div>
      </div>
      <style jsx>{`
